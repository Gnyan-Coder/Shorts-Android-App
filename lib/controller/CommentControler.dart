...
import 'package:tiktok/model/CommentModel.dart';
...
class CommentController extends GetxController{
  ...
  postComment(String commentText)async{
    ...
    if(commentText.isNotEmpty){
      ...
      Get.snackbar("Please Enter some content", "please wire somethings in comments");
    }}catch(e){
      Get.snackbar("Error in sending", e.toString());
    }
  }
